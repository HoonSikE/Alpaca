...
def talker():
    ...
    ego_setting_msg.number_of_ego_vehicle = 4
    ego_setting_msg.camera_index = 1
    ego_setting_msg.ego_index = [2, 7]
    ego_setting_msg.global_position_x = [45.0, 55, 65, 75] 
    ego_setting_msg.global_position_y = [1201.1, 1200, 1300, 1400]
    ...
    ego_setting_msg.velocity=[20.0, 20, 20, 20]
    ego_setting_msg.gear=[4, 4, 4, 4]
    ego_setting_msg.ctrl_mode=[16, 16, 16, 16] 
